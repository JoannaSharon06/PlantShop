...
function AboutUs() {
  return (
    <div className="about-us-container">
      ...
      {/* <p className="plant_logo_left"><img src="../public/plantclip.jpg" height='50px' width='50px' alt="" /></p> */}
      <p className="about-us-content">
        Our team of experts is dedicated to ensuring that each plant meets our strict standards of quality and care. 
        Whether youre a seasoned gardener or just starting your green journey, we're here to support you every step of 
        the way. Feel free to explore our collection, ask questions, and let us help you find the perfect plant for your 
        home or office.
      </p>
      {/* <p className="plant_logo_right"><img src="../public/plantclip.jpg" height='50px' width='50px' alt="" /></p> */}
